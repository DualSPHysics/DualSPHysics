...
class JShiftingZone : protected JObject
{
private:
...
public:
  const unsigned Id;
  JShiftingZone(unsigned id,const tdouble3 &posref,const tdouble3 &vx,const tdouble3 &vy,const tdouble3 &vz);
  ~JShiftingZone();
  void Reset();
...
class JShifting : protected JObject
{
private:
  JLog2* Log;
...
public:
  JShifting(bool simulate2d,double dp,float h,JLog2* log);
  ~JShifting();
  void Reset();
