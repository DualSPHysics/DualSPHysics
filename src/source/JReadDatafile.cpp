...
std::string JReadDatafile::ReadNextValue(bool in_line){
  if(in_line && ReadLine.empty())RunException("ReadNextValue",fun::PrintStr("Value %d does not exist in line %d.",ReadLinValue+1,ReadLin+1),File);
