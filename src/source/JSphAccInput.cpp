...
//==============================================================================
bool JSphAccInput::ExistMk(bool bound,word mktype)const{
  bool ret=false;
...
//==============================================================================
void JSphAccInput::ComputeVelocity(const JLinearValue &acedata,JLinearValue &veldata)const{
...
//==============================================================================
void JSphAccInput::Init(const JSphMk *mkinfo){
  for(unsigned c=0;c<GetCount();c++){
    JSphAccInputMk* ip=Inputs[c];
    //-Check configuration.
...
//=====================================================================================================================================================
const StAceInput& JSphAccInput::GetAccValues(unsigned cinput,double timestep){
