...
/// \file JSpaceUserVars.cpp \brief Implements the class \ref JSpaceUserVars.
...
/// Constructor.
//==============================================================================
JSpaceUserVars::JSpaceUserVars(){
  ClassName="JSpaceUserVars";
  Reset();
}
...
/// Sort funtion.
//==============================================================================
bool JSpaceUserVarsSort(const JSpaceUserVars::StVar &a,const JSpaceUserVars::StVar &b){ 
...
//==============================================================================
void JSpaceUserVars::LoadExportVars(const JNumexLib *nuxlib){
  Reset();
  ...
  //-Sort variables.
  std::sort(Vars.begin(),Vars.end(),JSpaceUserVarsSort);
}

//==============================================================================
/// Reads particles information in XML format.
//==============================================================================
void JSpaceUserVars::ReadXml(const JXml *sxml,TiXmlElement* lis){
...
//==============================================================================
void JSpaceUserVars::WriteXml(JXml *sxml,TiXmlElement* lis)const{
  lis->Clear();
...
//==============================================================================
void JSpaceUserVars::LoadFileXml(const std::string &file,const std::string &path){
  JXml jxml;
  jxml.LoadFile(file);
...
//==============================================================================
void JSpaceUserVars::LoadXml(const JXml *sxml,const std::string &place,bool optional){
  Reset();
...
//==============================================================================
void JSpaceUserVars::SaveXml(JXml *sxml,const std::string &place)const{
...
//==============================================================================
JSpaceUserVars::StVar JSpaceUserVars::GetVar(unsigned idx)const{
