...
//------------------------------------------------------------------------------
__device__ bool PointInMinMax(const double3& pt,const double3& pmin
  ,const double3& pmax)
{
...
//------------------------------------------------------------------------------
__device__ float PlaneDistSign(const float4& pla,const float& ptx
  ,const float& pty,const float& ptz)
{ 
...
//------------------------------------------------------------------------------
__device__ double TriangleArea(const double3& p1,const double3& p2
  ,const double3& p3)
{
...
//------------------------------------------------------------------------------
__device__ double LinePointDist(const double3& pt,const double3& pr1
  ,const double3& pr2)
{
