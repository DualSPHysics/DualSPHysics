...
protected:
  ...
  bool AleForm;               ///<ALE formulation for advanced shifting> <ShiftImpr>
  ...
  float  CoefDtMin;          ///<Coefficient to calculate minimum time step. dtmin=coefdtmin*h/speedsound (def=0.05).
