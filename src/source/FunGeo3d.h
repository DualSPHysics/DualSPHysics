...
//==============================================================================
inline bool PointInMinMax(const tdouble3& pt,const tdouble3& pmin
  ,const tdouble3& pmax)
{
...
/// Returns true when pmin <= pt <= pmax.
//==============================================================================
inline bool PointInMinMax(const tfloat3& pt,const tfloat3& pmin
  ,const tfloat3& pmax)
{
  return(pmin.x<=pt.x && pmin.y<=pt.y && pmin.z<=pt.z && pt.x<=pmax.x && pt.y<=pmax.x && pt.z<=pmax.z);
}
...
//==============================================================================
inline double LinePointDist(const tdouble3& pt,const tdouble3& pr1
  ,const tdouble3& pr2)
{
...
/// Returns the distance between a point and a line between two points.
//==============================================================================
inline float LinePointDist(const tfloat3& pt,const tfloat3& pr1
  ,const tfloat3& pr2)
{
