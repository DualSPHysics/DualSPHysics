...
public:
  ...
  JGaugeFlow*     AddGaugeFlow (std::string name,double computestart,double computeend,double computedt,bool fixed  //<vs_flowdat>
      ,const jmsh::StMeshBasic& meshbas,float kclimit,unsigned buffersize);                                         //<vs_flowdat> 
