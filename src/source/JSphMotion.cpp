...
/// Constructor.
//==============================================================================
JSphMotion::JSphMotion(bool simulate2d):Simulate2D(simulate2d){
...
//==============================================================================
const StMotionData& JSphMotion::GetMotionData(unsigned idx)const{
...
//==============================================================================
void JSphMotion::SetMotionDataAce(const StMotionData& d){
  SetMotionData(d);
  StMotionData &m=ObjMotion[d.ref];
  m.linace=d.linace;
  m.matmov2=d.matmov2;
...
/// Defines no motion for indicated object.
//==============================================================================
void JSphMotion::SetMotionDataNone(unsigned idx){
...
//==============================================================================
void JSphMotion::SetMotionDataLin(unsigned idx,const tdouble3 &linmov){
...
//==============================================================================
void JSphMotion::SetMotionDataMat(unsigned idx,const tmatrix4d &matmov){
  if(idx<GetNumObjects()){
    //printf("JSphMotion::SetMotionData-> idx:%d tp:%d  motion:(%g,%g,%g)\n",idx,tpmov,simplemov.x,simplemov.y,simplemov.z);
