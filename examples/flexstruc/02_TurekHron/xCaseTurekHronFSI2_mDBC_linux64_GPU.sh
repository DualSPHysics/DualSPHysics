...
export name=CaseTurekHronFSI2_mDBC
...
${partvtk} -dirin ${diroutdata} -savevtk ${dirout2}/PartWalls -onlymk:11
if [ $? -ne 0 ] ; then fail; fi

${partvtk} -dirin ${diroutdata} -savevtk ${dirout2}/PartClamp -onlymk:12
if [ $? -ne 0 ] ; then fail; fi
