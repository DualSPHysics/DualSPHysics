...
protected:
  ...
  float *ViscDtg;
  float *ViscEtaDtg;  //<vs_non-Newtonian>
  ...
  //<vs_non-Newtonian>
  float ViscEtaDtMax;      ///<Max value of ViscDt calculated in Interaction_Forces() / Valor maximo de ViscDt calculado en Interaction_Forces().
